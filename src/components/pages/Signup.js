...
function Signup(props) {
  ...
  const submitData = (event) => {
    ...
    props.authRegister(email, password, mobile_number, history)
  }
              ...
              <div className="py-16 px-2 sm:px-10 lg:px-16 space-y-7">
                ...
                >
                  <div>
                    ...
                    <input
                      className="focus:outline-none px-5 py-3 bg-white border-2 border-gray-300 rounded-xl w-full"
                      type="email"
                      name="email"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-white hover:bg-gray-300 border-2 border-gray-300 px-5 py-2 rounded-xl font-bold w-full"
                    >
                      Sign Up with google
                    </button>
                  </div>
