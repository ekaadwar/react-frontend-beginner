           ...
           {/* <!-- section jumbotron --> */}
            <section class="jumbotron">
                <div class="container mx-auto">
                    ...
                    <button class="bg-white leading-10 px-5 rounded-l-full"><i class="fa fa-search"></i></button><input class="leading-10 pl-5 rounded-r-full" type="text" name="search" placeholder="Search" />
                    </form>
                    <div class="w-1/2 text-white">
                    <h1>Start Your Day with</h1>
                    <h1>Coffee and Good Meals</h1>
                    <p class="text-xl mt-10">We provide high quality beans, good taste, and healthy meals made by love just for you. Start your day with us for a bigger smile!</p>
                    <button class="bg-yellow-500 hover:bg-yellow-300 text-xl mt-10 px-10 py-2 text-yellow-900 font-bold">Get Started</button>
                    </div>
                </div>
            </section>
            ...
            <section id="advantages">
                <div class="container mx-auto grid h-full w-full">
                    ...
                    <div class="grid grid-cols-2 self-center">
                        <div class="box-advent rounded-full"><i class="fas fa-user"></i></div>
                        <div>
                        <h1>90+</h1>
                        <p>Staff</p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 self-center">
                        <div class="box-advent rounded-full"><i class="fas fa-map-marker-alt"></i></div>
                        <div>
                        <h1>30+</h1>
                        <p>Store</p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 self-center">
                        <div class="box-advent rounded-full"><i class="fas fa-heart"></i></div>
                        <div>
                        <h1>800+</h1>
                        <p>Customers</p>
                        </div>
                    ...
                    <div class="h-full">
                        <img class="w-full self-center" src="img/general/advantages.jpg" alt="Team Work" />
                    </div>
                    <div class="px-10">
                        <div class="self-center">
                        <h1 class="text-4xl font-bold mb-5">We Provide Good Coffe<br />and Healthy Meals</h1>
                        <p class="mb-5">You can explore the menu that we provide with fun and have their own taste and make your day better.</p>
                        <ul>
                            <li>
                            <svg class="inline" class="inline" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <li>
                            <svg class="inline" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                d="M10.1216 0.549316C4.60758 0.549316 0.121582 5.03532 0.121582 10.5493C0.121582 16.0633 4.60758 20.5493 10.1216 20.5493C15.6356 20.5493 20.1216 16.0633 20.1216 10.5493C20.1216 5.03532 15.6356 0.549316 10.1216 0.549316ZM8.12258 14.9623L5.11703 11.9632C4.72628 11.5733 4.72549 10.9405 5.11527 10.5496C5.50529 10.1585 6.13859 10.1578 6.52951 10.548L8.12058 12.1363L12.7076 7.54932C13.098 7.15885 13.7311 7.15885 14.1216 7.54932C14.512 7.93978 14.512 8.57285 14.1216 8.96332L8.12258 14.9623Z"
                                fill="#2FAB73"
                                />
            ...
            <section id="fevorite" class="bg-gray-100 pb-10">
                <div class="container mx-auto">
                    ...
                    <h3 class="font-bold text-3xl pt-20 mb-1.5">Here is People's Favorite</h3>
                    <p class="mb-20">Let's choose and have a bit taste of people's favoite. It might be your tool</p>
                    </div>
                    ...
                    <div class="flex-1 flex justify-center">
                        ...
                        <div class="list">
                            ...
                            <h1 class="text-xl font-bold text-center mb-2">Hazelnut Latte</h1>
                            <ul>
                                <li>
                                <svg class="inline" class="inline" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="cost">
                            ...
                            <button class="text-l font-bold border-2 border-yellow-500 px-10 py-2 rounded-full focus:outline-none hover:border-transparent hover:bg-yellow-300">Order Now</button>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 flex justify-center">
                        ...
                        <div class="list">
                            <div class="leading-10">
                            <h1 class="text-xl font-bold text-center mb-2">Pinky Promise</h1>
                            <ul>
                                <li>
                                <svg class="inline" class="inline" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="flex-1 flex justify-center">
                        ...
                        <div class="list">
                            <div class="leading-10">
                            <h1 class="text-xl font-bold text-center mb-2">Chicken Wings</h1>
                            <ul>
                                <li>
                                <svg class="inline" class="inline" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <section id="spot" class="bg-gray-100 pb-10">
                <div class="container mx-auto text-center">
                    <h3 class="font-bold text-3xl pt-20 mb-1.5 w-1/3 mx-auto mb-5">Visit Our Store in the Spot on the Map Below</h3>
                    <p class="w-2/5 mx-auto mb-40">See our store in every city on the spot and spen your good day there. See you soon!</p>
                    <img class="mx-auto" src="../../../img/general/jumbotron.png" alt="Spot Area Coffee Shop" />
                </div>
            </section>
            {/* <!-- akhir section spot --> */}
            ...
            <section id="partner" class="bg-gray-100 pb-10">
                <div class="container mx-auto text-center">
                    <h3 class="font-bold text-3xl pt-20 w-1/3 mx-auto mb-16">Our Partner</h3>
            ...
            <div class="container mx-auto space-y-7 text-center">
                <h3 class="font-bold text-3xl pt-20 w-96 mx-auto">Loved by Thousand of Happy Customer</h3>
                <p class="sub-judul mx-auto">These are the stories of our customer who have visited us with great pleasure.</p>
                ...
                <div class="test-bar flex justify-between">
                    ...
                    <div class="head flex justify-between items-center">
                        ...
                        <img class="h-9 w-9" src="img/profile/robert.png" alt="Viezh Robert" />
                        <div class="pl-5">
