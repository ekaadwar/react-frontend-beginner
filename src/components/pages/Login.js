            ...
            <div class="w-1/2 bg-white">
              <div class="p-16 space-y-7">
                ...
                <form class="space-y-7">
                  ...
                  <a
                    class="inline-block text-yellow-800 font-bold"
                    href="forgot.html"
                  >
                    Forgot password?
                  </a>
                  ...
                  <button
                    class="block bg-yellow-500 hover:bg-yellow-300 px-5 py-2 rounded-xl font-bold w-full"
                    type="submit"
                  >
                    Login
                  </button>
                  ...
                  <div>
                    <button class="block bg-white hover:bg-gray-300 border-2 border-gray-300 px-5 py-2 rounded-xl font-bold w-full">
                      Login with google
                    </button>
                  </div>
                </form>
