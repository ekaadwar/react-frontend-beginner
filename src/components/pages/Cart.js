      ...
      <section class="cart pt-20 h-screen">
        <div class="container flex justify-center mx-auto h-full">
          <div class="inline-block space-y-10">
            <h2 class="text-3xl font-bold text-white text-shadow w-auto">
              Chekout your
              <br />
              item now!
            </h2>
            <div class="cart-body flex space-x-20">
              <div>
                <div class="order flex flex-col justify-between h-full w-72 px-5 py-16 bg-white rounded-2xl text-sm">
                  <h3 class="text-xl font-bold text-center text-yellow-900">
                    Order Summary
                  </h3>
                  <div class="grid grid-cols-3">
                    <div class="item h-12 w-12 bg-blue-200 rounded-xl overflow-hidden justify-center items-center">
                      <img
                        class="h-full w-full"
                    ...
                    <div class="item h-12 w-12 bg-blue-200 rounded-xl overflow-hidden">
                      <img
                        class="h-full w-full"
                ...
                <form class="flex flex-col justify-between h-full w-72">
                  <div>
                    ...
                    <div class="px-5 py-5 bg-white rounded-2xl">
                      <p>
                        <span class="font-bold">Delivery</span> to Iskandar
                  ...
                  <div>
                    <h4 class="text-shadow flex justify-between items-center text-white font-bold">
                      Payment method
                    </h4>
                    <div class="px-5 py-5 bg-white rounded-2xl space-y-5">
                      <div class="flex items-center space-x-3">
                        ...
                        <label class="flex items-center space-x-3" for="card">
                          <div class="flex justify-center items-center h-10 w-10 bg-yellow-600 rounded-md text-white">
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <label class="flex items-center space-x-3" for="bank">
                          <div class="flex justify-center items-center h-10 w-10 bg-yellow-900 rounded-md text-white">
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <label class="flex items-center space-x-3" for="cash">
                          <div class="flex justify-center items-center h-10 w-10 bg-yellow-400 rounded-md text-white">
                  ...
                  <input
                    class="w-72 bg-yellow-900 text-white hover:bg-yellow-800 py-3 rounded-xl"
                    type="submit"
