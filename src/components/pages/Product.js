            ...
            <div class="content flex h-screen divide-x divide-gray-300 divide-solid">
              ...
              <div class="side flex flex-col justify-between py-10">
                ...
                <div class="space-y-5">
                  ...
                  <button class="w-72 py-4 ml-10 bg-yellow-900 rounded-2xl text-white font-bold">
                    Apply Coupon
                  </button>
                </div>
                {/* <!-- bagian ketentuan --> */}
                ...
                <div class="flex flex-col justify-between w-full h-full p-10">
                  <div>
                    <ul class="flex justify-evenly">
                      <li class="inline-block">Favorite Product</li>
                      <li class="inline-block">Coffee</li>
                      <li class="inline-block">Non Coffee</li>
                      <li class="inline-block">Foods</li>
                      <li class="inline-block">Add-on</li>
                    </ul>
                  </div>
